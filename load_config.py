...
def load_config_from_file():
    ...
    try:
        ...
        late_morning = loaded_config.get('early_morning', dict(start_hour=8, start_min=45, end_hour=9, end_min=15))
        late_night = loaded_config.get('early_night', dict(start_hour=22, start_min=30, end_hour=23, end_min=0))
